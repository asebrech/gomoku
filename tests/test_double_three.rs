use gomoku::core::{board::{Board, Player}};
    ...
    fn test_creates_double_three_basic_case() {
        ...
        assert!(board.creates_double_three(6, 8, Player::Max));
    }
...
fn test_creates_double_three_diagonal() {
    ...
    assert!(board.creates_double_three(9, 9, Player::Max));
}
    ...
    fn test_single_free_three_allowed() {
        ...
        assert!(!board.creates_double_three(5, 6, Player::Max));
    }
    ...
    fn test_no_space_for_open_four() {
        ...
        assert!(!board.creates_double_three(0, 2, Player::Max));
    }
    ...
    fn test_complex_double_three_scenario() {
        ...
        */
        ...
        let creates_double = board.creates_double_three(9, 8, Player::Max);
    ...
    fn test_edge_cases() {
        ...
        assert!(!board.creates_double_three(0, 1, Player::Max));
    }
