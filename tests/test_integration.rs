...
fn test_find_best_move_different_depths() {
    ...
    let result1 = find_best_move(&mut state, 1, None, &tt);
    let result3 = find_best_move(&mut state, 3, None, &tt);
...
fn test_find_best_move_player_alternation() {
    ...
    let result_max = find_best_move(&mut state, 2, None, &tt);
    ...
    let result_min = find_best_move(&mut state, 2, None, &tt);
...
fn test_find_best_move_state_preservation() {
    ...
    // Find best move
    let _result = find_best_move(&mut state, 2, None, &tt);
...
fn test_find_best_move_consistent_results() {
    ...
    let result1 = find_best_move(&mut state, 2, None, &tt);
    let result2 = find_best_move(&mut state, 2, None, &tt);
...
fn test_find_best_move_different_board_sizes() {
    ...
    let result13 = find_best_move(&mut state13, 2, None, &tt);
    let result15 = find_best_move(&mut state15, 2, None, &tt);
