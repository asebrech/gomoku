...
/// Handles move validation and generation
...
/// Validates game rules including forbidden moves
...
impl RuleValidator {
    ...
    pub fn is_free_three(board: &Board, row: usize, col: usize, player: Player, direction: (isize, isize)) -> bool {
        ...
        // Get the line of 7 positions centered on our move
        ...
        // Check if this line contains a free-three pattern
